...
-------------------------------------------------------------------------------------------------------------------
    ...
    sets.precast.JA['Berserk'] 				= {body="Pummeler's lorica +1"}
...
-------------------------------------------------------------------------------------------------------------------
    ...
    sets.precast.WS['Fell Cleave'].FullAcc = set_combine(sets.precast.WS['Fell Cleave'].MidAcc, { })
    ...
    sets.precast.WS['Judgment'].MidAcc = set_combine(sets.precast.WS['Judgment'], { })
    sets.precast.WS['Judgment'].FullAcc = set_combine(sets.precast.WS['Judgment'].MidAcc, { })
------------------------------------------------------------------------------------------------------------------- 
-- Idle sets
-------------------------------------------------------------------------------------------------------------------
