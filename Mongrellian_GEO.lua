...
function init_gear_sets()
    ...
    sets.precast.JA['Life Cycle'] = {body="Geomancy Tunic +2",  back={ name="Nantosuelta's Cape", augments={'MP+60','Eva.+20 /Mag. Eva.+20','Pet: "Regen"+10','Damage taken-5%',}}}
    ...
    sets.midcast.Geomancy = {
        main={ name="Idris", augments={'Mag. Acc.+20','Pet: Damage taken -4%','"Fast Cast"+5',}},
        sub="Genmei shield",
        range={ name="Dunna", augments={'MP+20','Mag. Acc.+10','"Fast Cast"+3',}},
    ...
    sets.midcast.EnhancingDuration = {
        ...
        sub="Ammurapi Shield",
        range={ name="Dunna", augments={'MP+20','Mag. Acc.+10','"Fast Cast"+3',}},
        head={ name="Telchine Cap", augments={'Mag. Acc.+10','"Fast Cast"+5','Enh. Mag. eff. dur. +10',}},
        ...
        legs={ name="Telchine Braconi", augments={'"Mag.Atk.Bns."+15','"Fast Cast"+4','Enh. Mag. eff. dur. +10',}},
        feet={ name="Telchine Pigaches", augments={'Mag. Acc.+5','"Cure" spellcasting time -4%','Enh. Mag. eff. dur. +9',}},
        neck="Incanter's Torque",
        waist="Olympus Sash",
